...
export const getComputationAuditUserPage = (
  ...
  $config?: AxiosRequestConfig,
): AxiosPromise<ApiResultIPageAuditUserDto> => {
  let backendApiUrl = `/computation/audit/user/page`;

  return axios.request<ApiResultIPageAuditUserDto>({
    url: backendApiUrl,
    method: 'GET',
...
export const getComputationAuditNodeListCurr = (
  ...
  $config?: AxiosRequestConfig,
): AxiosPromise<ApiResultListAuditNode> => {
  let backendApiUrl = `/computation/audit/node/list/curr`;

  return axios.request<ApiResultListAuditNode>({
    url: backendApiUrl,
    method: 'GET',
    params: serializeQueryParam({
...
export const getComputationDataId = (
  ...
  $config?: AxiosRequestConfig,
): AxiosPromise<ApiResultComputationData> => {
  let backendApiUrl = `/computation/data/${id}`;

  return axios.request<ApiResultComputationData>({
    url: backendApiUrl,
    method: 'GET',
    params: serializeQueryParam({
      id: id,
...
export const getComputationAuditLogList = (
  ...
  $config?: AxiosRequestConfig,
): AxiosPromise<ApiResultListAuditLog> => {
  let backendApiUrl = `/computation/audit/log/list`;

  return axios.request<ApiResultListAuditLog>({
    url: backendApiUrl,
    method: 'GET',
    params: serializeQueryParam({
      computationDataId: computationDataId,
...
export const getComputationComputationOrgEmissionListId = (
  ...
  $config?: AxiosRequestConfig,
): AxiosPromise<ApiResultListComputation> => {
  let backendApiUrl = `/computation/computation/org/emissionList/${id}`;

  return axios.request<ApiResultListComputation>({
    url: backendApiUrl,
    method: 'GET',
    params: serializeQueryParam({
      id: id,
...
export const getComputationAuditPage = (
  ...
  $config?: AxiosRequestConfig,
): AxiosPromise<ApiResultIPageAuditData> => {
  let backendApiUrl = `/computation/audit/page`;

  return axios.request<ApiResultIPageAuditData>({
    url: backendApiUrl,
    method: 'GET',
    params: serializeQueryParam({
...
export const getComputationReportPage = (
  ...
  $config?: AxiosRequestConfig,
): AxiosPromise<ApiResultIPageReport> => {
  let backendApiUrl = `/computation/report/page`;

  return axios.request<ApiResultIPageReport>({
    url: backendApiUrl,
    method: 'GET',
    params: serializeQueryParam({
...
export interface ApiResultComputationData {
  code?: number;
...
export interface ApiResultIPageAuditData {
  code?: number;
  data?: IPageAuditData;
  msg?: string;
}

export interface ApiResultIPageAuditUserDto {
  code?: number;
...
export interface ApiResultIPageReport {
  code?: number;
  data?: IPageReport;
  msg?: string;
}

export interface ApiResultListAuditLog {
  code?: number;
  data?: AuditLog[];
  msg?: string;
}

export interface ApiResultListAuditNode {
  code?: number;
  data?: AuditNode[];
  msg?: string;
}
...
export interface ApiResultListComputation {
  code?: number;
  data?: Computation[];
  msg?: string;
}
...
export interface ComputationDataReq {
  computationDataId?: number;
